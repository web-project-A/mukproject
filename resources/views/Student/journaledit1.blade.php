        ...
        <div class="card-header"><strong><h3>EDIT DAILY JOURNALS</h3></strong></div>
            <div class="card-body card-block">
                ...
                <form method="POST" action="/filljournalEdit/{{$journal->id}}">
                    ...
                    <div class="form-group"><label for="date" class=" form-control-label">{{ __("Week Ending") }}</label><input name="date" value="{{ $journal->date }}" type="date" id="date" required class="form-control @error('date') is-invalid @enderror">
                        @error('date')
