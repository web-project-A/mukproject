            ...
            <div class="card-body card-block">
                <form method="POST" action="/Studentplacement">
                    ...
                    @if(session()->has('Success'))
                        ...
                        @endif
                    <div class="form-group"><label for="field_supervisor_fname" class=" form-control-label">{{ __("Field Supervisor's First Name") }}</label><input name="field_supervisor_fname" type="text" id="field_supervisor_fname" placeholder="" required class="form-control"></div>
        ...
        <div class="card-header"><strong><h3>ORGANISATION DETAILS</h3></strong></div>
            <div class="card-body card-block">
                <form method="POST" action="/Studentorg">
                    ...
                    <div class="form-group"><label for="contact" class=" form-control-label">{{ __("Organisation's Contact") }}</label><input name="contact" type="text" id="contact" placeholder="" required class="form-control"></div>
